...
<div class="p-5 mb-4 bg-light rounded-3">
    <div class="container py-5">
        <h1 class="display-5 fw-bold">Blog > Setting User</h1>
    </div>
</div>
<div class="container">
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= base_url('admin/update-status/published/') . $val['id'] ?>"
                        class="btn btn-sm btn-primary">Published</a>
                    <?php elseif($val['status'] === 'draft'): ?>
                    <a href="<?= base_url('admin/update-status/draft/')  . $val['id']?>"
